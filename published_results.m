...
switch setup
    case 3
        ...
        user_input = {{path_groups,path_data,path_output},{'id','','Time','X','Y'},{3,str2num('4,4,4'),3},{90,100,100,100,50,110,6,0,0},{250,0.9}};
    ...
    case 2
        % Segmentation + Features
        user_input = {{path_groups,path_data,path_output},{'id','','Time','X','Y'},{3,str2num('4,4,4'),3},{90,100,100,100,50,110,6,0,0},{250,0.7}};
    ...
    case 1
        % Segmentation + Features 
        user_input = {{path_groups,path_data,path_output},{'id','','Time','X','Y'},{3,str2num('4,4,4'),3},{90,100,100,100,50,110,6,0,0},{300,0.7}};
