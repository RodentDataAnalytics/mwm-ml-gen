function RUN_ALL_RESULTS( segmentation_configs, classification_configs, labels_path, folds, group_1, group_2 )
    ...
    results_latency_speed_length (segmentation_configs, group_1, group_2, 0);
    results_strategies_distributions_length (segmentation_configs, classification_configs, group_1, group_2, 0);
